...
./app/pktgen -c 1ff -n 3 --proc-type auto --socket-mem 256,256 --file-prefix pg -b 0000:03:00.0 -b 0000:03:00.1 -b 0000:07:00.0 -b 0000:07:00.1 -- -T -P -m "[1:3].0, [2:4].1, [5:7].2, [6:8].3" -f black-yellow.theme
fi
